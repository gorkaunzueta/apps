...
/* Modification for GPIO testing */
#include "bcm2835_lib.h"
#include <stdio.h>
#include <signal.h>
#include <stdlib.h>

/* Modification to use the MPU9DOF library */
...
void SAMPLE_APP_Main(void)
{
    ...
    */
    ...
    //if (!bcm2835_init()){
    //    CFE_ES_WriteToSysLog("Sample App: Error Initializing bcm2835");
    //    SAMPLE_APP_Data.RunStatus = CFE_ES_RunStatus_APP_ERROR;
    //}
    
    //if(!bcm2835_i2c_begin()){
        //OS_printf("Sample App: I2C begin failed \n");
    //} 
    ...
    // Define the mpu9dof class
    mpu9dof.slave_address =         MPU9DOF_XLG_I2C_ADDR_0;
    mpu9dof.magnetometer_address =  MPU9DOF_M_I2C_ADDR_0;
    ...
    */
    while (CFE_ES_RunLoop(&SAMPLE_APP_Data.RunStatus) == true)
    {
        ...
        */
        ...
        // HIGH = 1
        //bcm2835_gpio_write(LED_1, on_off);
        
        mpu9dof_read_accel ( &mpu9dof, &accelx, &accely, &accelz );
	
        OS_printf("Sample App: Acceleration X: %d, Acceleration Y: %d, Acceleration Z: %d. \n", accelx, accely, accelz);
